  ...
  <div class="app-container">
    ...
    <el-row :gutter="10">
      <el-col :span="1.5">
        <el-button
          ...
          @click="openExport"
          v-hasPermi="['salesReportManagement:salesDepartmentPerformanceTrends:export']"
    ...
    >
      <el-table-column
        ...
        align="center"
        v-if="checkPermi(['salesReportManagement:salesDepartmentPerformanceTrends:export'])"
      >
      </el-table-column>
...
import {
  ...
  querySalesTrendCurveForSalesDepartment
} from '@/api/salesReportManagement/salesDepartmentPerformanceSummary'

import PieChart from './PieChart'
export default {
  name: 'SalesDepartmentPerformanceTrends',
  dicts: [],
  mixins: [pageMixin],
  components: { PieChart },
  data() {
    ...
    return {
      ...
      searchData: [
        ...
        },
        {
          ...
          label: this.$t('SALES.salesDepartment'),
          type: 'ElcascaderEle',
          width: '230px',
          mapValue: 'value',
          mapLabel: 'label',
  ...
  methods: {
    ...
    getList(query) {
      ...
      this.querySalesTrendCurveForSalesDepartment()
    },
    querySalesTrendCurveForSalesDepartment() {
      const params = {
      ...
      querySalesTrendCurveForSalesDepartment(params).then((res) => {
        const data = res.data || {}
        ...
        this.monthOptions = {
          legendData: imageLineList.map((item) => item.departmentName),
        ...
        this.yearOptions = {
          legendData: imageLineList1.map((item) => item.departmentName),
    ...
    querySearchList() {
      querySearchListForSalesDepartment({ labelType: this.activeName }).then((res) => {
        const data = res.data || {}
        const arr = data.branchCompanyList || []
        this.handle(arr)
    ...
    handleExport(data) {
      ...
      this.$importOrExportDownFile(
        ...
        params,
        `${this.getFileNameDate('Sales Department Performance Trends')}.xlsx`
      )
        .then((res) => {
