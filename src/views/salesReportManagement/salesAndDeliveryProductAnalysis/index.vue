    ...
    <div class="app-container" v-if="currentIndex === 1">
      ...
      <el-row :gutter="10">
        <el-col :span="1.5">
          <el-button
            ...
            @click="openExport"
            v-hasPermi="['salesReportManagement:salesAndDeliveryProductAnalysis:export']"
      ...
      >
        <el-table-column
          ...
          align="center"
          v-if="checkPermi(['salesReportManagement:salesAndDeliveryProductAnalysis:export'])"
        >
        </el-table-column>
...
import productDetail from '@/views/salesReportManagement/salesDeliveryRateAnalysis/productDetail.vue'

export default {
  name: 'SalesAndDeliveryProductAnalysis',
  dicts: [],
  mixins: [pageMixin],
    ...
    return {
      ...
      columns: [
        ...
        },
        {
          ...
          label: vm.$t('SALES.accurateDeliveryRate'),
          minWidth: 160,
          visible: true,
          tooltip: true,
          padding: 50,
  ...
  methods: {
    ...
    handleExport(data) {
      ...
      this.$importOrExportDownFile(
        '/sales/report/salesDeliveryRateAnalysis/exportForCustomerProduct',
        params,
        `${this.getFileNameDate('Sales and Delivery Product Analysis')}.xlsx`
      )
        .then((res) => {
