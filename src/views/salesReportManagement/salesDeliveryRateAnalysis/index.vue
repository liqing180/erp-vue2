    ...
    <div class="app-container" v-if="currentIndex === 0">
      ...
      <el-row :gutter="10">
        <el-col :span="1.5">
          <el-button
            ...
            @click="openExport"
            v-hasPermi="['salesReportManagement:salesDeliveryRateAnalysis:export']"
      ...
      >
        <el-table-column
          ...
          align="center"
          v-if="checkPermi(['salesReportManagement:salesDeliveryRateAnalysis:export'])"
        >
        </el-table-column>
...
export default {
  name: 'SalesDeliveryRateAnalysis',
  dicts: [],
  mixins: [pageMixin],
  ...
  methods: {
    ...
    handleExport(data) {
      ...
      this.$importOrExportDownFile(
        '/sales/report/salesDeliveryRateAnalysis/exportForCustomer',
        params,
        `${this.getFileNameDate('Sales Delivery Rate Analysis')}.xlsx`
      )
        .then((res) => {
