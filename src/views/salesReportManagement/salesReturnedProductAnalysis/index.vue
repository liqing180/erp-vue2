    ...
    <div class="app-container" v-if="currentIndex === 1">
      ...
      <el-row :gutter="10">
        <el-col :span="1.5">
          <el-button
            ...
            @click="openExport"
            v-hasPermi="['salesReportManagement:salesReturnedProductAnalysis:export']"
      ...
      >
        <el-table-column
          ...
          align="center"
          v-if="checkPermi(['salesReportManagement:salesReturnedProductAnalysis:export'])"
        >
        </el-table-column>
...
import productDetail from '@/views/salesReportManagement/salesReturnsSummary/productDetail.vue'

export default {
  name: 'SalesReturnedProductAnalysis',
  dicts: [],
  mixins: [pageMixin],
  ...
  methods: {
    ...
    handleExport(data) {
      ...
      this.$importOrExportDownFile(
        '/sales/report/salesReturnAnalysis/exportForCustomerProduct',
        params,
