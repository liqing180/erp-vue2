    ...
    <div class="app-container" v-if="currentIndex === 0">
      ...
      <el-row :gutter="10">
        <el-col :span="1.5">
          <el-button
            ...
            @click="openExport"
            v-hasPermi="['salesReportManagement:salesReturnsSummary:export']"
      ...
      >
        <el-table-column
          ...
          align="center"
          v-if="checkPermi(['salesReportManagement:salesReturnsSummary:export'])"
        >
        </el-table-column>
...
export default {
  name: 'SalesReturnsSummary',
  dicts: [],
  mixins: [pageMixin],
  components: { productAnalysis, productDetail },
  data() {
    const vm = this
    return {
      saveKey: '1',
      ...
      columns: [
        ...
        },
        {
          ...
          label: vm.$t('SALES.salesOrderQTY'),
          visible: true,
          minWidth: 200,
          tooltip: true,
          padding: 60,
        ...
        {
          prop: 'returnOrderQty',
          label: vm.$t('SALES.returnOrderQTY'),
          visible: true,
          minWidth: 200,
          tooltip: true,
          padding: 60,
  ...
  methods: {
    ...
    handleExport(data) {
      ...
      this.$importOrExportDownFile(
        '/sales/report/salesReturnAnalysis/exportForCustomer',
        params,
        `${this.getFileNameDate('Sales Returns Summary')}.xlsx`
      )
        .then((res) => {
