...
import {
  queryProductListFromSalesCostSettings,
  queryProductListFromSalesCostSettingsNoPage
...
export default {
  ...
  methods: {
    ...
    getList() {
      ...
      this.loading = true
      queryProductListFromSalesCostSettings(param)
        .then((response) => {
          this.loading = false
    ...
    addAll() {
      ...
      queryProductListFromSalesCostSettingsNoPage(param)
        .then((res) => {
          const data = res.data || []
