...
import { querySGRCanSelectDeliveryOrderList } from '@/api/salesManagement/salesGoodsReturn'
...
export default {
  ...
  data() {
    ...
    return {
      ...
      queryParams: {
        pageNum: 1,
        pageSize: 25,
        conditionForDeliveryOrderNo: ''
      },
      searchData: [
        {
          name: 'conditionForDeliveryOrderNo',
          placeholder: `${this.$t('SALES.deliveryOrderNo')}`,
          type: 'InputEle'
        },
        {
  ...
  computed: {
    ...
    showAllAuth() {
      return this.checkPermi(['salesManagement:salesGoodsReturn:departmentData'])
    }
  },
  beforeCreate() {
