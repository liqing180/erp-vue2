          ...
          <el-collapse-item name="1">
            ...
            >
              <el-row>
                ...
                <el-col :span="8">
                  <el-form-item :label="`${$t('system.parentStructure')}`" prop="postParentName">
...
<script>
import { addPost, getPost, updatePost, queryPostCanSelectDepartment } from '@/api/system/post'
...
export default {
  ...
  created() {
    ...
    if (this.postId) {
      ...
      if (deptIds) {
        this.$set(this.form, 'departmentIdList', deptIds.split(','))
      }
  ...
  methods: {
    ...
    updatePostParent(e = {}) {
      this.$set(this.form, 'postParentId', e.postId)
      this.$set(this.form, 'postParentName', e.postName)
    },
    postParentClear() {
      this.$set(this.form, 'postParentId', undefined)
      this.$set(this.form, 'postParentName', undefined)
    },
    // 取消按钮
    cancel() {
      if (this.isView) {
