...
<script>
import { queryUomList, delUom, exportUom } from '@/api/system/uom'
import { querySystemAllUomList } from '@/api/system/user'
...
export default {
  ...
  methods: {
    ...
    getList() {
      ...
      queryUomList(params).then((response) => {
