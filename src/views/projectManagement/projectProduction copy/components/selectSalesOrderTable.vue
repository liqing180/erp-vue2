...
import { queryCanSelectSalesOrderListFromProjectProduction } from '@/api/projectManagement/projectProduction'
...
export default {
  ...
  methods: {
    ...
    getList() {
      ...
      queryCanSelectSalesOrderListFromProjectProduction(param)
        .then((response) => {
