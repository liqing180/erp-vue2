<template>
  ...
  >
    ...
    <div slot="footer" class="dialog-footer">
      <el-button type="ghost" @click="handleBack">{{ $t('uiBtn.cancel') }}</el-button>
      <el-button type="primary" @click="handleBack">{{ $t('PRODUCT.ConfirmContinue') }}</el-button>
    </div>
  </el-dialog>
</template>
  ...
  data() {
    ...
    return {
      ...
      columns: [
        ...
        {
          prop: 'thisAllocationQty',
          label: vm.$t('PRODUCT.thisAllocationQty'),
          visible: true,
          minWidth: 200,
          padding: 60,
          tooltip: true
