...
import { queryProductListFromInventoryInitialization } from '@/api/inventoryManagement/inventoryInitialization'
...
export default {
  ...
  methods: {
    ...
    getList() {
      ...
      this.loading = true
      queryProductListFromInventoryInitialization(param)
        .then((response) => {
          this.loading = false
