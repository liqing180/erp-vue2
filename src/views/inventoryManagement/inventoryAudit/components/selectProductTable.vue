...
import { queryAdjustmentCanSelectProductListForWMS } from '@/api/inventoryManagement/inventoryAudit'
...
export default {
    ...
    return {
      ...
      columns: [
        ...
        // },
        {
          ...
          label: vm.$t('INVENTORY.productCategory'),
          visible: true,
          minWidth: 200
          // tooltip: true
        },
        ...
        {
          prop: 'availableQty',
          label: vm.$t('INVENTORY.availableQTY'),
          visible: true,
          minWidth: 200,
          padding: 60,
          tooltip: true
        ...
        {
          prop: 'reservedQty',
          label: vm.$t('INVENTORY.reservedQTY'),
          visible: true,
          minWidth: 200,
          padding: 60,
          tooltip: true
        ...
        {
          prop: 'inTransitQty',
          label: vm.$t('INVENTORY.inTransitQTY'),
          visible: true,
          minWidth: 200,
          padding: 60,
          tooltip: true
  ...
  methods: {
    ...
    getList() {
      ...
      param.alreadySelectLabelDetailIdList = this.alreadySelectIdList
      param.warehouseId = this.formData.warehouseId
      this.loading = true
      this.$trimOfObj(param)
      queryAdjustmentCanSelectProductListForWMS(param)
        .then((response) => {
          this.loading = false
