...
<script>
import { importInventoryAdjustmentProduct } from '@/api/inventoryManagement/inventoryAudit'
    ...
    return {
      ...
      importOptions: {
        ...
        url:
          ...
          '/inventory/inventoryAudit/checkImportInventoryAdjustmentProduct'
      },
      fileList: [],
      updateSupport: 0,
  ...
  methods: {
    ...
    downLoad() {
      ...
      this.$importOrExportDownFile(
        '/inventory/inventoryAudit/exportInventoryAdjustmentProduct',
        {
          warehouseId: this.warehouseId
        },
        `${this.getFileNameDate('Inventory Adjustment')}.xlsx`
      )
        .then((res) => {
            ...
            .then((res) => {
              this.$modal
                ...
                .then(() => {
                  ...
                  formData.append('warehouseId', vm.warehouseId)
                  return importInventoryAdjustmentProduct({ formData })
                })
                .then((response) => {
                ...
                .catch((err) => {
                  this.btnLoading = false
                  if (this.$TypeJudge.isObject(err) && err.code === 701) {
                    this.cancel()
                  }
                })
            })
