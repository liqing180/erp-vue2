    ...
    <el-row :gutter="10">
      <el-col :span="1.5">
        <el-button
          ...
          icon="el-icon-plus"
          size="mini"
          v-hasPermi="['inventoryManagement:inventoryCostAnalysis:add']"
          @click="handleAdd"
      ...
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleImport"
          v-hasPermi="['inventoryManagement:inventoryCostAnalysis:import']"
          >{{ $t('menu.importExpenseDetails') }}</el-button
        >
      </el-col>
      <el-col :span="1.5">
        <el-button
...
export default {
  ...
  data() {
    ...
    return {
      ...
      importOptions: {
        // 下载模板
        downFileUrl: '/system/productExtended/importInventoryCostTemplate',
        // 上传校验
        uploadUrl:
          process.env.VUE_APP_BASE_API + '/inventory/inventoryCostSettings/checkImportData',
        // 提交导入
        importUrl: '/inventory/inventoryCostSettings/importData',
        // 下载文件名
  ...
  methods: {
    ...
    handleAdd(row) {
      this.$router.push({
        path: '/inventoryManagement/addCostSettings',
    ...
    handleDblclick(row, column) {
      ...
      this.$router.push({
        path: '/inventoryManagement/editCostSettings',
    ...
    handleExport(data) {
      ...
      this.$importOrExportDownFile(
        ...
        params,
        `${this.getFileNameDate('Cost Settings')}.xlsx`
      )
        .then((res) => {
