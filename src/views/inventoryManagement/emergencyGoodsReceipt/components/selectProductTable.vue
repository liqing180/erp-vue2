        ...
        <pagination
          :selectedNum="
            $$getFilteredSelectedNum(
              ...
              tableList,
              activeName === '1'
                ? selectList1.filter((i) => i.isCustomProduct !== '1')
                : selectList2,
              rowIdKey
            )
          "
...
import { queryEGRCanSelectProductList } from '@/api/inventoryManagement/emergencyGoodsReceipt'
  ...
  methods: {
    ...
    getList() {
      ...
      if (this.activeName === '1') {
        ...
        queryFn = queryEGRCanSelectProductList
