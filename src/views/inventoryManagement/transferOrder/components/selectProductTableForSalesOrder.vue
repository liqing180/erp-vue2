...
import { queryProductListFromTransferOrderHaveSalesOrder } from '@/api/inventoryManagement/transferOrder'
...
export default {
  ...
  methods: {
    ...
    getList() {
      ...
      // param.alreadySelectProductIdList = this.alreadySelectIdList
      param.fromWarehouseId = this.formData.fromWarehouseId
      param.toWarehouseId = this.formData.toWarehouseId
      param.transferOrderId = this.formData.transferOrderId
      param.salesOrderId = this.formData.salesOrderId
      param.salesOrderTransferOrderType = this.formData.salesOrderTransferOrderType
      this.$trimOfObj(param)
      this.loading = true
      queryProductListFromTransferOrderHaveSalesOrder(param)
        .then((response) => {
          this.loading = false
