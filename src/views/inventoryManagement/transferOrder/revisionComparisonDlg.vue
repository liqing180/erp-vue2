        ...
        <el-collapse-item name="3" v-if="beforeDetailList.length > 0">
          ...
          <div class="mb20">
            ...
            >
              ...
              >
                <template slot-scope="scope">
                  <template v-if="item.prop === 'availableQtyFrom'">
                    <template>{{
...
<script>
import { queryUpdateMsgTransferOrder } from '@/api/inventoryManagement/transferOrder'
export default {
  props: {
    businessPartnerId: {
      default: ''
  ...
  methods: {
    ...
    handleOpen(id) {
      ...
      queryUpdateMsgTransferOrder({ transferOrderId: id }).then((res) => {
