<template>
  <el-dialog
    v-dialogDrag
    v-dialogDragWidth
    :title="$t('INVENTORY.storeIssueChitDetails')"
...
import { querySicQtyMsg } from '@/api/inventoryManagement/inventoryReport'
      ...
      columns: [
        {
          ...
          label: vm.$t('INVENTORY.storeIssueChit'),
          visible: true,
          minWidth: 200,
          tooltip: true
        },
