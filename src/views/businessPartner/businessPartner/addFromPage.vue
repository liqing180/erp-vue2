          ...
          <div class="form-card">
            <el-collapse-item name="1">
              ...
              >
                ...
                <!-- <span class="ml20">用户名: {{ form.userName }}</span> -->
              </FormCollapseItemTitle>
              <el-form
                ref="form1"
                :model="form"
              ...
              >
                <el-row>
                  <el-col :span="16">
                    <el-form-item :label="`${$t('ui.category')}`" prop="typeList">
                      ...
                      >
                        <el-checkbox label="0">{{ $t('ui.customer') }}</el-checkbox>
                        <el-checkbox label="1">{{ $t('ui.supplier') }}</el-checkbox>
                      </el-checkbox-group>
                    </el-form-item>
                  </el-col>
                </el-row>
                <el-row>
                  ...
                  <el-col :span="8">
                    <el-form-item
                      :label="`${$t('ui.businessPartnerCode')}`"
                      :rules="[
                        {
                          required: form.isAutoBusinessPartnerNo === '0',
                          pattern: new RegExp(/^(?!(\s+$))/g),
                          message: $t('ui.reqMsg').replace('$1', $t('ui.businessPartnerCode')),
                          trigger: ['blur']
                        }
                      ]"
                    ...
                    >
                      ...
                      <div class="input-switch-box">
                        <div class="con-left">
                          <el-input
                            :disabled="form.isAutoBusinessPartnerNo === '1'"
                        ...
                        <div class="con-right">
                          <el-switch
                            v-model="form.isAutoBusinessPartnerNo"
                            active-value="1"
                            inactive-value="0"
                            @change="changeEmployeeNoSwitch('businessPartnerNo')"
                          ></el-switch>
                        </div>
                      </div>
                    </el-form-item>
                ...
                <el-row>
                  <el-col :span="8">
                    <el-form-item :label="`${$t('ui.companyRegNo')}`" prop="companyRegNo">
                      <el-input v-model="form.companyRegNo" maxlength="200"></el-input>
                    </el-form-item>
                  </el-col>
                  <el-col :span="8">
...
export default {
  ...
  methods: {
    ...
    handleAdd() {
      ...
      // let param = localStorage.getItem('customerParam') || '{}'
      // if (param !== '{}') {
      //   param = JSON.parse(param)
      //   const {
      //     bpBusinessAccountSupplier,
      //     bpBusinessAccountCustomer,
      ...
      //   } = param
      //   this.form = params
      //   this.accForm1 = bpBusinessAccountSupplier
      //   this.accForm2 = bpBusinessAccountCustomer

      //   this.contactPersonList = param.bpBusinessContactPersonList
      //   this.projectCustomerAddressList = param.projectCustomerAddressList

      //   this.addressList = param.bpBusinessAddressList
      //   this.projectList = param.projectList
      //   if (this.addressList.length > 0 && this.projectList.length > 0) {
      //     this.handlerAddress()
      //     this.handlerProject()
      //   }
      //   setTimeout(() => {
    ...
    reset() {
      this.form = {
        ...
        businessPartnerStatus: undefined,
        businessPartnerName: undefined,
        businessPartnerNo: undefined,
        isAutoBusinessPartnerNo: '1',
        email: undefined,
        alias: undefined,
        mobileNum: undefined,
      ...
      console.log(this.legalEntityInfo, '===')
      // this.$set(this.form, 'mobileCode', this.legalEntityInfo.mobileCode)
    ...
    async submitForm() {
      ...
      if (valid1 && valid2) {
        ...
        console.log(param, '==1559')
        localStorage.setItem('customerParam', JSON.stringify(param))
