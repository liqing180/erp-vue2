...
import {
  queryPurchaseOrderListFromLogisticsExpense,
  querySearchListFromLogisticsExpense
...
export default {
  ...
  methods: {
    handleAdd(alreadySelectIdList) {
      ...
      this.querySearchListFromLogisticsExpense()
    },
    querySearchListFromLogisticsExpense() {
      const param = {}
      ...
      querySearchListFromLogisticsExpense(param).then((res) => {
        const data = res.data || {}
    ...
    getList() {
      ...
      param.documentDetailIdList = this.alreadySelectIdList
      this.loading = true
      const queryFn = queryPurchaseOrderListFromLogisticsExpense
      queryFn(param)
        .then((response) => {
