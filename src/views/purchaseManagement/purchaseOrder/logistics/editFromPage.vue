          ...
          <div class="form-card">
            <el-collapse-item name="1">
              ...
              >
                ...
                <!-- <el-row>
                  <el-col :span="8" :class="[isModified('automatedEmail')]">
...
import RevisionComparisonDlg from '@/views/purchaseManagement/purchaseOrder/logistics/revisionComparisonDlg.vue'
