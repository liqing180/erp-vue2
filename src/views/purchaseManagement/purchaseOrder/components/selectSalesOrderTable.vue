...
import { queryCanSelectSalesOrderListFromPurchaseDropShipping } from '@/api/purchaseManagement/purchaseOrder'
...
export default {
  ...
  methods: {
    ...
    getList() {
      ...
      const queryFN = queryCanSelectSalesOrderListFromPurchaseDropShipping
