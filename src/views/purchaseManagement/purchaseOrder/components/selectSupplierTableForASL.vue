...
import { queryPurchaseOrderCanSelectBusinessPartnerListForASL } from '@/api/purchaseManagement/purchaseOrder'
...
export default {
  ...
  methods: {
    ...
    getList() {
      ...
      queryPurchaseOrderCanSelectBusinessPartnerListForASL(param)
        .then((response) => {
