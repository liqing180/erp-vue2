<template>
  <el-dialog
    v-dialogDrag
    v-dialogDragWidth
    :title="$t('PURCHASE.consignmentOrder')"
...
import { queryCanSelectConsignmentOrderList } from '@/api/purchaseManagement/purchaseReturnOrder'
...
export default {
  ...
  data() {
    ...
    return {
      ...
      searchData: [
        ...
        {
          name: 'conditionForConsignmentOrderNo',
          label: this.$t('PURCHASE.consignmentOrderNo'),
  ...
  methods: {
    ...
    getList() {
      ...
      queryCanSelectConsignmentOrderList(param)
        .then((response) => {
