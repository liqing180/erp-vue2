...
import {
  queryInventoryCostDocumentList,
  icQuerySearchList
...
export default {
  ...
  methods: {
    ...
    getList() {
      ...
      this.loading = true
      queryInventoryCostDocumentList(param)
        .then((response) => {
    ...
    handleExport(data) {
      ...
      this.$importOrExportDownFile(
        '/inventory/inventoryCostDocument/exportInventoryCostDocumentList',
        params,
