...
import { queryImageForPurchaseCost } from '@/api/reportManagement/inventoryCostAnalysis'
...
export default {
  ...
  methods: {
    openChart(productId, documentId) {
      this.$set(this.form, 'productId', productId)
      this.$set(this.form, 'documentId', documentId)
      this.visible = true
      this.queryImageForPurchaseCost()
    },
    queryImageForPurchaseCost() {
      ...
      queryImageForPurchaseCost(params).then((response) => {
        this.$nextTick(() => {
