...
import {
  queryPurchaseCostProductWarehouseDocumentList,
  queryPurchaseCostProductWarehouseDocumentSearchList
...
export default {
  ...
  methods: {
    ...
    getList() {
      this.queryPurchaseCostProductWarehouseDocumentSearchList()
      ...
      queryPurchaseCostProductWarehouseDocumentList(param)
        .then((response) => {
    ...
    detailsSummary() {
      this.$refs.detailsSummaryDlg.handleOpen(this.productId, this.warehouseId)
    },
    handleDetail(row) {
