...
import { queryInventoryCostProductDocumentLogisticsList } from '@/api/reportManagement/inventoryCostAnalysis'
...
export default {
  ...
  methods: {
    ...
    getList() {
      ...
      queryInventoryCostProductDocumentLogisticsList(param)
        .then((response) => {
