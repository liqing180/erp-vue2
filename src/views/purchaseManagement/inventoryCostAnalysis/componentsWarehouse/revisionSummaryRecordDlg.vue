...
import { querySummaryListByProductWarehouseDocument } from '@/api/purchaseManagement/distributionByWarehouse'
...
export default {
  ...
  methods: {
    ...
    getList() {
      ...
      querySummaryListByProductWarehouseDocument(params)
        .then((response) => {
