...
import {
  queryProductListFromInventoryCostSettings,
  queryProductListFromInventoryCostSettingsNoPage
...
export default {
  ...
  methods: {
    ...
    getList() {
      ...
      queryProductListFromInventoryCostSettings(param)
        .then((response) => {
          this.loading = false
    ...
    addAll() {
      ...
      queryProductListFromInventoryCostSettingsNoPage(param)
        .then((res) => {
          const data = res.data || []
