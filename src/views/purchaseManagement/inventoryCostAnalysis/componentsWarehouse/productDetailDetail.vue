...
import { queryPurchaseCostProductWarehouseDocumentLogisticsList } from '@/api/purchaseManagement/distributionByWarehouse'
...
export default {
  ...
  methods: {
    ...
    getList() {
      ...
      queryPurchaseCostProductWarehouseDocumentLogisticsList(param)
        .then((response) => {
