...
import { queryPurchaseCostProductDocumentLogisticsRevisedList } from '@/api/reportManagement/inventoryCostAnalysis'
...
export default {
  ...
  methods: {
    ...
    getList() {
      ...
      param.purchaseCostProductDocumentLogisticsId =
        this.form.purchaseCostProductDocumentLogisticsId
      this.$trimOfObj(param)
      queryPurchaseCostProductDocumentLogisticsRevisedList(param)
        .then((response) => {
