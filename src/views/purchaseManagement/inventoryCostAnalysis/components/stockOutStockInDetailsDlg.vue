...
import { queryInventoryCostProductDocumentLogisticsRevisedList } from '@/api/reportManagement/inventoryCostAnalysis'
...
export default {
  ...
  methods: {
    ...
    getList() {
      ...
      params.inventoryCostProductDocumentLogisticsId =
        this.form.inventoryCostProductDocumentLogisticsId
      this.$trimOfObj(params)
      queryInventoryCostProductDocumentLogisticsRevisedList(params)
        .then((response) => {
