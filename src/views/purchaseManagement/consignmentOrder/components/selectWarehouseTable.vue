...
import { queryCanSelectConsignmentWarehouseList } from '@/api/purchaseManagement/consignmentOrder'
...
export default {
  ...
  methods: {
    ...
    getList() {
      ...
      param.consignorId = this.businessPartnerId
      param.menuPerms = this.menuKey.consignmentOrder
      this.$trimOfObj(param)

      queryCanSelectConsignmentWarehouseList(param)
        .then((response) => {
