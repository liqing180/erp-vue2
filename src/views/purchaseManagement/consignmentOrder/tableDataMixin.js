export default {
  ...
  data() {
    ...
    const columns0 = [
      ...
      {
        prop: 'consignmentOrderStatus',
        propBy: 'consignmentOrderStatusStr',
    ...
    return {
      ...
      tabs: [
        ...
        // {
        //   name: this.$t('PURCHASE.pendDelivery'),
        //   value: '3'
        // },
        {
      ...
      searchData0: [
          ...
          selectData: [
            {
              ...
              value: 'conditionForConsignmentOrderNo'
            }
            // { label: this.$t('PURCHASE.DONo'), value: 'conditionForDeliveryOrderNo' }
          ],
          selectName: 'selectId',
          inputName: 'inputVal',
          selectId: '',
        ...
        {
          name: 'consignmentOrderStatusList',
          label: vm.$t('ui.status'),
          type: 'MultipleSelectEle',
          width: '200px',
          selectValue: 'value',
