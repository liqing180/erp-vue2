...
import { queryAssignmentCanSelectProductList } from '@/api/inventoryManagement/warehouseAssignment'
    ...
    return {
      ...
      columns: [
        ...
        },
        {
          ...
          visible: true,
          minWidth: 140,
          fixedWidth: vm.comDisFrom ? undefined : 170,
          tooltip: true,
          padding: 50,
          align: 'right'
        },
...

        {
          ...
          visible: true,
          minWidth: 200,
          colMinWidth: vm.comDisFrom ? undefined : 150,
          tooltip: true
        },
        {
          prop: 'leadTime',
