...
import { queryRFQCanSelectWarehouseList } from '@/api/purchaseManagement/requestForQuotation'
...
export default {
  ...
  methods: {
    ...
    getList() {
      ...
      param.menuPerms = this.menuKey.ASL
      queryRFQCanSelectWarehouseList(param)
        .then((response) => {
