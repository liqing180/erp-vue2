...
export default {
  ...
  methods: {
    ...
    updateSupplier(row) {
      const data = this.tableList[this.index]
    ...
    handleRowAssign() {
      ...
      */
      ...
      const { logisticsDocumentProductList } = this.totalForm
      const tableList = JSON.parse(JSON.stringify(logisticsDocumentProductList || []))
