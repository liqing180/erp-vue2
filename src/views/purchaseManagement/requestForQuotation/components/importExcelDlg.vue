...
<script>
import { importRFQProductImportTemplate } from '@/api/purchaseManagement/requestForQuotation'
    ...
    return {
      ...
      importOptions: {
        ...
        url:
          ...
          '/purchase/requestForQuotation/checkRFQProductImportTemplate'
      },
      fileList: [],
      updateSupport: 0,
  ...
  methods: {
    ...
    downLoad() {
      ...
      this.$importOrExportDownFile(
        '/purchase/requestForQuotation/exportRFQProductImportTemplate',
        {},
        `${this.getFileNameDate('RFQ Product')}.xlsx`
      )
        .then((res) => {
            ...
            .then((res) => {
              vm.$modal
                ...
                .then(() => {
                  ...
                  return importRFQProductImportTemplate({ formData })
                })
                .then((response) => {
                  vm.btnLoading = false
