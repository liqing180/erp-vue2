<template>
  <div class="app-container">
    ...
    >
      ...
      <el-form-item label-width="100px" :label="$t('ui.executionTime')">
        <el-date-picker
          v-model="dateRange"
          size="small"
          style="width: 240px"
    ...
    >
      ...
      <el-table-column :label="$t('ui.operId')" width="80" align="center" prop="jobLogId" />
      <el-table-column
        :label="$t('ui.jobName')"
        align="center"
        prop="jobName"
      ...
      />
      <el-table-column
        :label="$t('ui.logInformation')"
        align="center"
        prop="jobMessage"
        :show-overflow-tooltip="true"
      />
      <el-table-column :label="$t('ui.status')" align="center" prop="status">
        <template slot-scope="scope">
          <dict-tag :options="dict.type.sys_common_status" :value="scope.row.status" />
        </template>
      </el-table-column>
      <el-table-column :label="$t('ui.executionTime')" align="center" prop="createTime" width="180">
        <template slot-scope="scope">
    ...
    >
      <el-form ref="form" :model="form" label-width="100px" size="mini">
        <el-row>
          <el-col :span="12">
            <el-form-item :label="`${$t('ui.sn')}：`">{{ form.jobLogId }}</el-form-item>
            <el-form-item :label="`${$t('ui.jobName')}：`">{{ form.jobName }}</el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item :label="`${$t('ui.jobGroup')}：`">{{ form.jobGroup }}</el-form-item>
            <el-form-item :label="`${$t('ui.executionTime')}：`">{{
              form.createTime
            }}</el-form-item>
          </el-col>
          <el-col :span="24">
          ...
          <el-col :span="24">
            <el-form-item :label="`${$t('ui.logInformation')}：`">{{
              form.jobMessage
            }}</el-form-item>
          </el-col>
          <el-col :span="24">
          ...
          <el-col :span="24">
            <el-form-item :label="`${$t('ui.exceptionInfo')}：`" v-if="form.status == 1">{{
              form.exceptionInfo
            }}</el-form-item>
          </el-col>
        </el-row>
      ...
      <div slot="footer" class="dialog-footer">
        <el-button @click="open = false">{{ $t('uiBtn.close') }}</el-button>
      </div>
    </el-dialog>
  </div>
</template>
