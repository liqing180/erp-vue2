      ...
      queryListForSupplierProductOrder(param)
        .then((response) => {
          ...
          rows.forEach((item) => {
            ...
            item.reallyPurchaseQtyForBasic = this.$numberStr(item.reallyPurchaseQtyForBasic, 3)
            item.stockInQtyForBasic = this.$numberStr(item.stockInQtyForBasic, 3)
            item.accurateDeliveryQtyForBasic = this.$numberStr(item.accurateDeliveryQtyForBasic, 3)
