...
<script>
import { queryListForBusinessProduct } from '@/api/reportManagement/supplierIncomingMaterialForPoorAnalysis'
...
export default {
  ...
  data() {
    ...
    return {
      ...
      searchData: [
        {
          name: 'conditionForBusinessProduct',
          type: 'InputEle',
  ...
  methods: {
    getList(query) {
      ...
      queryListForBusinessProduct(param)
        .then((response) => {
    ...
    handleExport(data) {
      ...
      this.$importOrExportDownFile(
        '/purchase/report/incomingAnalysis/exportForBusinessProduct',
        params,
