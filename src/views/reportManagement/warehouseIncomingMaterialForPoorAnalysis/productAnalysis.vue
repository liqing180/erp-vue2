...
<script>
import { queryListForWarehouseProduct } from '@/api/reportManagement/warehouseIncomingMaterialForPoorAnalysis'
...
export default {
  ...
  data() {
    ...
    return {
      ...
      searchData: [
        {
          name: 'conditionForWarehouseProduct',
          type: 'InputEle',
  ...
  methods: {
    getList(query) {
      ...
      queryListForWarehouseProduct(param)
        .then((response) => {
    ...
    handleExport(data) {
      ...
      this.$importOrExportDownFile(
        '/purchase/report/incomingAnalysis/exportForWarehouseProduct',
        params,
