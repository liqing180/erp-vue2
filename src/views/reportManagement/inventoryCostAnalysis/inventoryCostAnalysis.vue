...
import {
  queryInventoryCostList,
  inventoryCostQuerySearchList
...
export default {
  ...
  methods: {
    ...
    getList() {
      this.inventoryCostQuerySearchList()
    ...
    // 搜索下拉值
    inventoryCostQuerySearchList() {
      inventoryCostQuerySearchList({}).then((res) => {
    ...
    handleExport(data) {
      ...
      this.$importOrExportDownFile(
        '/inventory/inventoryCost/exportInventoryCostList',
        params,
