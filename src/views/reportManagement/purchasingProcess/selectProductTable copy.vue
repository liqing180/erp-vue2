    ...
    getList() {
      ...
      queryCanSelectProductListForPurchaseProcess(param)
        .then((response) => {
          ...
          //   item.availableQty = this.$numberStr(item.availableQty, this.$getDecNum(item.decimalNum))
          //   item.reservedQty = this.$numberStr(item.reservedQty, this.$getDecNum(item.decimalNum))
          //   item.inTransitQty = this.$numberStr(item.inTransitQty, this.$getDecNum(item.decimalNum))
          // })
          this.tableList = rows
