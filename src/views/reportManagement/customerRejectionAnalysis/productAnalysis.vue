  ...
  <FormPageLayout>
    ...
    <template v-slot:content>
      <div class="form-card app-container">
        ...
        <div class="mt20 flexCen">
          <PieChart
            ref="PieChart"
            height="500px"
            :analysis="true"
            :chartTitle="$t('PURCHASE.rejectedTopProduct')"
          />
        </div>
      </div>
    </template>
...
import {
  ...
  queryTopImageForCustomerProduct
...
export default {
  ...
  data() {
    ...
    return {
      ...
      searchData: [
        {
          name: 'conditionForCustomerProduct',
          type: 'InputEle',
  ...
  methods: {
    getList(query) {
      ...
      this.queryTopImageForCustomerProduct()
    },
    queryTopImageForCustomerProduct() {
      queryTopImageForCustomerProduct({
    ...
    handleExport(data) {
      ...
      this.$importOrExportDownFile(
        '/sales/report/rejectionAnalysis/exportForCustomerProduct',
        params,
