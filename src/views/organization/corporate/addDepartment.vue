          ...
          <el-collapse-item name="1">
            ...
            <el-form ref="createForm" :model="createForm" :rules="createRules" label-width="195px">
              <el-row>
                ...
                <el-col :span="8">
                  <el-form-item :label="`${$t('organization.branchCompany')}`" prop="branchCompany">
                    <el-input
                      v-model="createForm.branchCompany"
                      :title="createForm.branchCompany"
                      disabled
                      class="form-wd"
                    />
                  </el-form-item>
...
import { saveDepartment, queryDepartmentById, queryAllSysPost } from '@/api/organization/corporate'
