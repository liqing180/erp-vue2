            ...
            >
              <el-row>
                ...
                <el-col :span="8">
                  ...
                  >
                    <el-input v-model="createForm.superiorDepartment" disabled class="form-wd" />
                  </el-form-item>
                </el-col>
              </el-row>
    ...
    return {
      ...
      createRules: {
        departmentName: [
          {
            required: true,
            message: vm.$t('ui.reqMsg').replace('$1', vm.$t('organization.subDepartment')),
            trigger: ['blur', 'change'],
  ...
  methods: {
    ...
    queryDepartmentById() {
      queryDepartmentById(this.createForm.departmentId).then((res) => {
        ...
        this.$set(this.createForm, 'superiorDepartment', this.createForm.superiorDepartmentName)
