            ...
            >
              ...
              <el-row>
                ...
                <el-col :span="8">
                  ...
                  >
                    <!-- <el-input v-model="createForm.landlineNumber" :maxlength="50" class="form-wd" /> -->
                    <MobilePhoneInput
              ...
              <el-row>
                ...
                <el-col :span="8">
                  <el-form-item :label="`${$t('organization.trademark')}`" prop="trademark">
                    <div class="text-center" style="width: 120px">
                      <userAvatar
...
import { queryLegalEntityById, updateLegalEntity } from '@/api/organization/corporate'
  ...
  methods: {
    ...
    queryLegalEntityById(id) {
      ...
      queryLegalEntityById(id).then((res) => {
        ...
        if (CompanySeal) {
          this.$set(this.createForm, 'companySealUrl', CompanySeal.url)
          this.$set(this.createForm, 'fileIdsCompanySeal', CompanySeal.id || '')
        }
        const Trademark = this.createForm.commonFileListTrademark[0]
        if (Trademark) {
          this.$set(this.createForm, 'trademarkUrl', Trademark.url)
          this.$set(this.createForm, 'fileIdsTrademark', Trademark.id || '')
        }
    ...
    submitForm() {
      ...
      this.$refs.createForm.validate((valid) => {
        ...
        if (valid) {
          ...
          this.$modal.confirm(vm.$t('organization.legalEntitySaveConfirm')).then(() => {
