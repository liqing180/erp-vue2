<template>
  <div style="padding-bottom: 20px">
    ...
    <div v-if="radioValue === '2'">
      <el-checkbox-group v-model="customerBranchCompanyIdList" :disabled="!editAuth">
        <el-checkbox
  ...
  watch: {
    formData: {
      ...
      handler: function (newVal) {
        const { roleId, dpTypeCustomer, customerList, customerBranchCompanyIdList } = this.formData
        if (roleId) {
  ...
  methods: {
    ...
    submitForm() {
      return {
        ...
        customerBranchCompanyIdList: this.radioValue === '2' ? this.customerBranchCompanyIdList : []
      }
    }
  }
}
