        ...
        <div class="form-card">
          <el-collapse-item name="1">
            ...
            >
              <el-row>
                <el-col :span="8">
                  <el-form-item :label="`${$t('organization.parentStructure')}`">
                    <el-input
...
import { updateDepartment, queryDepartmentById } from '@/api/organization/department'
...
export default {
  ...
  methods: {
    ...
    queryDepartmentById() {
      queryDepartmentById({ departmentId: this.createForm.departmentId }).then((res) => {
        const data = res.data
