...
import { queryCanSelectProductListFromBomCombinationProduct } from '@/api/productManagement/BOMManagement'
...
export default {
  ...
  methods: {
    ...
    getList() {
      ...
      this.loading = true
      queryCanSelectProductListFromBomCombinationProduct(param)
        .then((response) => {
          this.loading = false
