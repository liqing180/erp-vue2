...
<script>
import { importData } from '@/api/businessPartner/businessPartner'
  ...
  data() {
    return {
      ...
      importOptions: {
        isUploading: false,
        // 上传的地址
        url: process.env.VUE_APP_BASE_API + '/system/businessPartner/checkImportData'
      },
      fileList: [],
      updateSupport: 0,
  ...
  methods: {
    ...
    downLoad() {
      ...
      this.$importOrExportDownFile(
        '/system/businessPartner/downTemplate',
        {},
