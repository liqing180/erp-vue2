...
import { queryAddressByBusinessPartnerIdFromProductSheet } from '@/api/purchaseManagement/purchaseContract'
...
export default {
  ...
  methods: {
    ...
    getList() {
      const vm = this
      this.loading = true
      const param = Object.assign({ ...this.queryParams, ...this.form })
      this.$trimOfObj(param)
      queryAddressByBusinessPartnerIdFromProductSheet(param)
        .then((response) => {
